...
=func bcrypt_crypt($password, $settings)

This is a C<crypt()> like interface to bcrypt. It serves mainly to ease transition from C<Crypt::Eksblowfish::Bcrypt> to this module.
